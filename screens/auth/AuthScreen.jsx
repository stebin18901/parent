...
export default function AuthScreen() {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      Alert.alert("Password Reset Sent", "A password reset link has been sent to your email.");
    } catch (error) {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <LinearGradient colors={["#F6FAFF", "#EEF2FF", "#FFF7ED"]} style={styles.gradient}>
        <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? "padding" : undefined}>
          <View style={styles.card}>
            ...
            <TouchableOpacity onPress={() => setIsLogin(!isLogin)}>
              <Text style={styles.switchText}>{isLogin ? "New user? Create an account" : "Already a user? Login"}</Text>
            </TouchableOpacity>
          </View>
        </KeyboardAvoidingView>
      </LinearGradient>
